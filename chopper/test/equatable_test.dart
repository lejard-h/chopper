...
void main() {
  ...
  group('Request', () {
    ...
    test('should return true when comparing two identical objects', () {
      expect(
        Request('GET', Uri.parse('/foo'), baseUrl, headers: {'bar': 'baz'}),
        equals(
          Request('GET', Uri.parse('/foo'), baseUrl, headers: {'bar': 'baz'}),
        ),
      );
    ...
    test(
      ...
      () => expect(request, equals(request.copyWith())),
    );

    test(
      'should return false when comparing two different objects',
      () => expect(request, isNot(equals(RequestFixture.factory.makeSingle()))),
    );
    ...
    test(
      ...
      () {
        expect(request, isNot(equals(faker.lorem.word())));
      },
    );
    ...
    test(
      ...
      () => expect(
        request,
        isNot(equals(request.copyWith(headers: {'bar': 'bazzz'}))),
      ),
    );
  });
  ...
  group('Response', () {
    ...
    test('should return true when comparing two identical objects', () {
      ...
      expect(
        ...
        equals(Response<Payload>(base, payload)),
      );
    });

    test(
      'should return true when comparing original with copy',
      () => expect(response, equals(response.copyWith<Payload>())),
    );
        ...
        isNot(
          equals(
            ResponseFixture.factory<Payload>()
                .redefine(
                  ResponseFixture.factory<Payload>().body(
                    PayloadFixture.factory.makeSingle(),
                  ),
                )
                .makeSingle(),
          ),
    ...
    test(
      'should return false when comparing to an object of a different type',
      () {
        expect(response, isNot(equals(faker.lorem.word())));
      },
    );
  ...
  group('PartValue', () {
    ...
    setUp(() {
      partValue = PartValue<String>(faker.lorem.word(), faker.lorem.word());
    });

    test('should return true when comparing two identical objects', () {
      expect(
        const PartValue<String>('foo', 'bar'),
        equals(const PartValue<String>('foo', 'bar')),
      );
    });

    test(
      'should return true when comparing original with copy',
      () => expect(partValue, equals(partValue.copyWith<String>())),
    );

    test(
      'should return false when comparing two different objects',
      () => expect(partValue, isNot(equals(const PartValue('bar', 'baz')))),
    );

    test(
      'should return false when comparing to null',
      () => expect(partValue, isNot(equals(null))),
    );

    test(
      'should return false when comparing to an object of a different type',
      () {
        expect(partValue, isNot(equals(faker.lorem.word())));
      },
    );

    test(
      'should return false when comparing to an object with different props',
      () => expect(partValue, isNot(equals(partValue.copyWith(value: 'bar')))),
    );
  });
}
