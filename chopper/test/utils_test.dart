  ...
  group('mapToQuery Strapi query', () {
    ...
    test('mapToQuery', () {
      expect(
        ...
        equals(
          r'filters.%24or.date.%24eq=2020-01-01&filters.%24or.date.%24eq=2020-01-02&filters.author.name.%24eq=Kai%20doe',
        ),
      );
    });
    ...
    test('mapToQuery with brackets', () {
      expect(
        ...
        equals(
          r'filters%5B%24or%5D%5Bdate%5D%5B%24eq%5D=2020-01-01&filters%5B%24or%5D%5Bdate%5D%5B%24eq%5D=2020-01-02&filters%5Bauthor%5D%5Bname%5D%5B%24eq%5D=Kai%20doe',
        ),
      );
    });
  });
